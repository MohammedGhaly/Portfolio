...
function TechStack() {
  return (
    <div className="techs-div flex h-fit w-full items-center justify-around bg-gray-600/10 px-2 py-3 backdrop-blur-xs *:transition-all *:duration-300 *:ease-in-out md:justify-center md:gap-10 lg:justify-around lg:gap-0 lg:pr-26 lg:pl-6 *:lg:opacity-40 *:lg:hover:opacity-100">
      <Image
        src={reactIcon}
        alt="react"
