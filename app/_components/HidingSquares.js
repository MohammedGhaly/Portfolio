...
function HidingSquares() {
  ...
  return (
    <div className="grid aspect-square grid-cols-3 grid-rows-3 place-items-center gap-7 rounded-2xl bg-gray-400/20 p-7 backdrop-blur-sm *:h-full *:w-full lg:gap-12 lg:p-12">
